                        ...
                        <div className="max-w-2xl px-4 mb-16 lg:mb-0 lg:w-1/2 lg:mr-0 lg:ml-auto">
                            ...
                            <div className="flex mb-6 text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    className="text-gray-600 w-7 h-7 bi bi-geo-alt" viewBox="0 0 16 16">
                                    <path
                            ...
                            <div className="flex mb-6 text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    className="text-gray-600 w-7 h-7 bi bi-telephone" viewBox="0 0 16 16">
                                    <path
                            ...
                            <div className="flex text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    className="text-gray-600 w-7 h-7 bi bi-envelope" viewBox="0 0 16 16">
                                    <path
